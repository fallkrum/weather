...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "-.weather" in the application's documents directory.
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    [Location initFetchedPropertiesInObjectModel:_managedObjectModel];
...
- (NSManagedObjectContext *)privateObjectContext {
    ...
    NSManagedObjectContext *mainObjectContext = [self managedObjectContext];
    _privateObjectContext =
    [[NSManagedObjectContext alloc] initWithConcurrencyType:NSPrivateQueueConcurrencyType];
    _privateObjectContext.parentContext = mainObjectContext;
